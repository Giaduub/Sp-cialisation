...
<div class="container-fluid">
  ...
  <nav class="navbar  navbar-light bg-light">
    ...
    <a class="navbar-brand goodPeople" href="#">Menu</a>
  </nav>
  ...
  <div class="socialmedia">
    <div class="flex-auto">
      <div class="margin-small">
        <div class="child-width-auto grid-small grid grid-stack" grid="">
          <div class="first-column"> <a class="el-link link-muted icon" target="_blank" rel="noreferrer"
              href="#" icon="icon: facebook;"> <svg width="20"
                height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="facebook">
                <path
      ...
      <div class="margin-remove-vertical">
        <div class="child-width-auto grid-small grid grid-stack" grid="">
          <div class="first-column"> <a class="el-link link-muted icon" target="_blank" rel="noreferrer"
              href="#" icon="icon: instagram;"><svg width="20" height="20"
      ...
      <div class="margin-small">
        <div class="child-width-auto grid-small grid grid-stack" grid="">
          <div class="first-column"> <a class="el-link link-muted icon" target="_blank" rel="noreferrer"
              href="#" icon="icon: linkedin;"><svg width="20"
                height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" data-svg="linkedin">
                <path
      ...
      <div class="margin">
        <div class="tm-rotate-180 vertical">Debug Dump Promo</div>
      </div>
    </div>
  </div>